...
class Encoder(nn.Module):
    ...
    def __init__(self, vocab_size, hidden_size, latent_size, seq_size, num_layers):
        ...
        self.RNN = nn.GRU(128, hidden_size, batch_first=True,
                        num_layers=num_layers, bidirectional = True)
        self.one_hot = nn.Embedding(vocab_size, 128)
...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_size, hidden_size, vocab_size, num_layers, seq_size):
        ...
        self.RNN = nn.GRU(128 + latent_size, hidden_size, batch_first = True, num_layers=num_layers)
        self.tanh = nn.Tanh()
    ...
    def forward(self, latent, temp, x, teacher_forcing, logits=False):
        ...
        if teacher_forcing:
            ...
            src_input = torch.cat((latent.unsqueeze(1).repeat(1,self.seq_size-1,1),x),2)
